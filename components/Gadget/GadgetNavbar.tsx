...
import { gadgetCategories } from "@/lib/navbarCategories";
...
/**
 * GadgetNavbar - Unified component for Gadget navbar with multiple variants
 */
export default function GadgetNavbar({ variant, routes = GADGET1_ROUTES }: GadgetNavbarProps) {
        ...
        <div className="flex items-center justify-between px-4 md:px-6 lg:px-8 py-4 h-16 w-full">
          <div className="flex items-center space-x-6">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link
                href={routes.HOME}
                className="text-sm font-semibold text-gray-900 hover:text-blue-600 transition-colors uppercase tracking-wider"
              >
                HOME
              </Link>
              <Link
              ...
              <MenuBar label="CATEGORIES" items={gadgetCategories} />
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2 md:space-x-3">
            ...
            <Link
              href={routes.CART}
              className="p-2 text-gray-800 hover:text-blue-600 transition-colors relative"
            >
            ...
            <Link
              ...
              className="hidden sm:block p-2 text-gray-800 hover:text-blue-600 transition-colors relative"
            >
            ...
            <button className="hidden sm:block p-2 text-gray-800 hover:text-blue-600 transition-colors">
    ...
    <div className="sticky top-0 z-50 bg-white w-full border-b border-gray-100">
      ...
      <div className="block md:hidden">
        <div className="flex items-center justify-between px-4 py-4 h-16 w-full">
          ...
          <Link href={routes.HOME} className="border-2 border-blue-600 p-2 w-fit">
            <div className="text-lg font-bold text-blue-600">GADGET</div>
            <div className="text-xs text-center text-blue-600">STORE</div>
          </Link>
          ...
          <div className="flex items-center space-x-1">
            <Link href={routes.CART} className="p-2 text-gray-800 hover:text-gray-600 hover:bg-gray-100 active:bg-gray-200 active:scale-95 transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 rounded-md relative">
              ...
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-blue-600 text-white text-xs font-bold w-4 h-4 rounded-full flex items-center justify-center text-[10px]">
                  {cartCount}
                </span>
              )}
            </Link>
