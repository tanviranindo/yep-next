          ...
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-white/95 mb-6">
                Stay updated with the latest tech trends and exclusive gadget
                offers
              </p>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Your one-stop destination for cutting-edge gadgets and
                technology. We bring you the latest innovations from around the
                world.
              </p>
              <div className="flex gap-3 pt-2">
                <Link
                  href="#"
                  className="w-10 h-10 bg-white/10 hover:bg-blue-600 hover:text-white text-white rounded-full flex items-center justify-center transition-all"
                >
                  <Facebook size={18} />
                </Link>
                <Link
          ...
          <div className="bg-white/5 rounded-2xl p-6 mb-8">
            <div className="flex flex-wrap justify-center items-center gap-8">
              ...
              {["Apple", "Samsung", "Dell", "HP", "Sony", "Microsoft"].map(
                (brand) => (
                  <div
                    key={brand}
          ...
          <div className="text-center text-gray-400 text-sm border-t border-gray-800 pt-6">
            <p>
              © 2025 TechHub. All Rights Reserved. | Innovation meets technology
            </p>
          </div>
        </div>
      </footer>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-white/90 mb-6">
              Subscribe to our newsletter for the latest gadget updates and
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Your trusted destination for cutting-edge gadgets and technology.
              We bring you the latest innovations from around the world.
            </p>
            <div className="flex gap-3 pt-2">
              <Link
                href="#"
        ...
        <div className="border-t border-gray-800 pt-8 pb-4">
          ...
          <div className="text-center text-gray-500 text-sm">
            <p>
              © 2025 Gadget Store. All Rights Reserved. | Technology redefined
            </p>
          </div>
        </div>
      </div>
