...
export type GadgetFilterVariant = 1 | 2;
          ...
          <span
            className={`w-6 h-6 border-2 rounded-md transition-all duration-200 flex items-center justify-center ${
              checked
                ...
                : "border-gray-300 group-hover:border-blue-600 bg-white"
            }`}
          >
            {checked && (
              <svg
  ...
  return (
    <div className="flex items-center gap-3 py-1 cursor-pointer">
      <input
        ...
        className="peer sr-only"
      />
      <span className="inline-grid place-items-center h-5 w-5 border-[1.5px] border-blue-600 bg-white peer-checked:border-blue-600 peer-checked:bg-blue-600 transition-colors duration-200">
...
interface GadgetFilterProps {
  variant: GadgetFilterVariant;
  filterProps?: FilterSidebarV1Props | FilterSidebarV2Props;
}

/**
 * GadgetFilter - Unified component for Gadget filter variants
 *
 * Variant 1: Gadget Store filter sidebar
 * Variant 2: TechHub filter sidebar
 */
export default function GadgetFilter({ variant, filterProps }: GadgetFilterProps) {
  const {
    action,
    price = variant === 1
      ? { min: 5000, max: 100000, value: 50000, name: "price", label: "Filter by Price" }
      : { min: 0, max: 100000, value: 100000, name: "price", label: "Filter by Price" },
    groups = variant === 1
      ? [
          {
            title: "Categories",
            name: "category",
            options: ["All", "Smartphones", "Laptops", "Accessories"],
            type: "checkbox",
          },
          {
            title: "Collections",
          ...
          },
          {
            title: "Availability",
            name: "availability",
            options: ["In stock (120)", "Out of stock (15)"],
            type: "checkbox",
          },
        ]
      : [],
      ...
      <aside className="w-full bg-white border border-gray-200 rounded-lg shadow-sm">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gray-50">
          ...
          <button
            ...
            className="text-sm text-blue-600 hover:text-blue-700 font-semibold transition-colors px-3 py-1 rounded-md hover:bg-blue-50"
          >
            Clear All
          </button>
        </div>
          ...
          <form method="get" action={action} className="space-y-8">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm font-medium text-blue-600 bg-white px-3 py-1 rounded-md">
              ...
              <div className="relative mb-4">
                ...
                <input
                  ...
                  step={1}
                  className="absolute inset-0 w-full h-3 bg-transparent appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-6 [&::-webkit-slider-thumb]:h-6 [&::-webkit-slider-thumb]:bg-blue-600 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-lg [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-white [&::-moz-range-thumb]:w-6 [&::-moz-range-thumb]:h-6 [&::-moz-range-thumb]:bg-blue-600 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-white [&::-moz-range-thumb]:shadow-lg"
                />
                <input
                  type="range"
                  min={absoluteMin}
            ...
            <div className="pt-6">
              <button
                className="w-full bg-blue-600 text-white py-4 px-6 font-bold text-base uppercase tracking-wider hover:bg-blue-700 transition-colors rounded-lg shadow-md hover:shadow-lg"
                type="button"
                onClick={() => {
      ...
      <form method="get" action={action} className="space-y-0">
        <div className="mb-8">
          ...
          <div className="relative mt-2 h-6">
            ...
            <div
              className="absolute top-1/2 -translate-y-1/2 h-[2px] bg-blue-600"
            ...
            <input
              ...
              step={1}
              className="absolute inset-0 z-10 w-full bg-transparent appearance-none pointer-events-none [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:bg-blue-600 [&::-webkit-slider-thumb]:rounded-full [&::-moz-range-thumb]:pointer-events-auto [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:bg-blue-600 [&::-moz-range-thumb]:border-none [&::-moz-range-thumb]:rounded-full"
            />
            <input
              type="range"
              min={absoluteMin}
              ...
              step={1}
              className="absolute inset-0 z-20 w-full bg-transparent appearance-none pointer-events-none [&::-webkit-slider-thumb]:pointer-events-auto [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:bg-blue-600 [&::-webkit-slider-thumb]:rounded-full [&::-moz-range-thumb]:pointer-events-auto [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:bg-blue-600 [&::-moz-range-thumb]:border-none [&::-moz-range-thumb]:rounded-full"
            />
          </div>
          <div className="mt-2 flex items-center justify-between">
            ...
            <button
              className="bg-blue-600 text-white px-6 py-2 text-[12px] uppercase tracking-[0.25em] leading-none hover:bg-blue-700 active:bg-blue-800 cursor-pointer"
              type="button"
              onClick={() => {
                console.log("Applying filters:");
                console.log("Selected Filters:", selectedFilters);
        ...
        {groups.map((g, idx) => (
          <div key={g.title} className="mb-8">
            {idx > 3 && <div className="border-t border-gray-300 mb-6"></div>}
            ...
            {g.title === "Collections" ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {g.options.map((o) => (
                  <button
                    key={o}
                    className="w-full h-8 bg-blue-600 text-white text-[12px] hover:bg-blue-700 active:bg-blue-800 active:scale-95 transition-all duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
                    name={g.name}
                    value={o}
                    type="submit"
                  >
