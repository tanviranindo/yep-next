...
export type GadgetLayoutVariant = 1 | 2;

interface GadgetLayoutProps {
  variant: GadgetLayoutVariant;
  routes?: Record<string, string>;
  heroProps?: any;
  products?: Product[];
}

export default function GadgetLayout({
  variant,
  routes,
  heroProps,
  products,
  ...
  const defaultProducts = gadgetProducts;
  const currentProducts = products || defaultProducts;

  // Use correct data based on variant
  const currentCategories = categories1;
  const currentSubcategories = subcategories1;
  const currentFilterProducts = filterProducts;
  const currentSortProducts = sortProducts;
  ...
  return (
    ...
    >
      {/* Navbar */}
      <GadgetNavbar variant={variant} routes={routes} />

      {/* Hero Section */}
      {heroProps && <GadgetHero variant={variant} {...heroProps} />}
        ...
        >
          ...
          <div className="md:hidden mb-6">
            <button
              ...
              className={
                variant === 1
                  ? "btn bg-blue-600 text-white w-full hover:bg-blue-700"
          ...
          {isFilterOpen && (
            ...
            >
              ...
              >
                ...
                <GadgetFilter variant={variant} filterProps={filterProps} />
              </div>
            </div>
          )}
            ...
            <div className="flex-1 min-w-0">
              ...
              >
                <div>
                  ...
                  >
                    {variant === 1 ? "Gadget Collection" : "Tech Collection"}
                  </h2>
                ...
                <select
                  ...
                  className={
                    variant === 1
                      ...
                      : "bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  }
                >
              ...
              >
                {displayProducts.map((p) => (
                  <GadgetProductCard key={p.id} variant={variant} product={p} />
                ))}
              </div>
