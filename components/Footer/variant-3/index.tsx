// Newsletter integration footer for Kids & Mom
    ...
    <footer className="bg-primary text-primary-content">
      <div className="footer p-10 max-w-7xl mx-auto">
        <aside>
          ...
          <p>YEP Kids & Mom<br/>Family essentials with love</p>
        </aside>
        <nav>
        ...
        <nav>
          <h6 className="footer-title">Mom</h6>
          <a className="link link-hover">Maternity</a>
          <a className="link link-hover">Self Care</a>
          <a className="link link-hover">Health</a>
          <a className="link link-hover">Wellness</a>
        </nav>
        <form>
          <h6 className="footer-title">Newsletter</h6>
          <fieldset className="form-control w-80">
            <label className="label">
              <span className="label-text text-primary-content">Enter your email address</span>
            </label>
            <div className="join">
      ...
      <div className="footer footer-center p-4 bg-primary text-primary-content">
        <aside>
          <p>Copyright © 2024 - All right reserved by YEP Family Ltd</p>
        </aside>
      </div>
    </footer>
  )
