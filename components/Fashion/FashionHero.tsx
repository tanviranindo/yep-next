...
/**
 * FashionHero - Unified component for Fashion hero variants
 *
 * Variant 1: Fashion Studio hero with product carousel
 * Variant 2: Insole hero with image slider
 */
export default function FashionHero(props: FashionHeroProps) {
  const [currentSlide, setCurrentSlide] = useState(0);

  if (props.variant === 2) {
    // Variant 2: Insole Hero
    const {
      slides = [
        {
