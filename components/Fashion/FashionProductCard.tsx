...
/**
 * FashionProductCard - Unified component for Fashion product card variants
 *
 * Variant 1: Fashion Studio product card with ProductCardVariant4
...
export default function FashionProductCard({ variant, product, className }: FashionProductCardProps) {
  ...
  if (variant === 2) {
    // Variant 2: Fashion2 / Insole Product Card
  ...
  // Variant 1: Fashion Studio Product Card
  const actions = [
    {
      icon: (
        <svg
