...
export type FurnitureFAQVariant = 1 | 2;
...
interface FurnitureFAQProps {
  variant: FurnitureFAQVariant;
  items: Array<{ q: string; a: string }>;
  columns?: 1 | 2;
}

/**
 * FurnitureFAQ - Unified component for Furniture FAQ variants
 *
 * Variant 1: Server-rendered collapsible FAQ using <details> (Furniture Studio)
 * Variant 2: Client component FAQ with contact form and state (Insole)
 */
export default function FurnitureFAQ({ variant, items, columns = 2 }: FurnitureFAQProps) {
  ...
  if (variant === 2) {
    // Variant 2: Furniture2 / Insole FAQ with contact form
    return (
  ...
  // Variant 1: Furniture Studio FAQ with details/summary
