...
export type FurnitureFooterVariant = 1 | 2;

interface FurnitureFooterProps {
  variant: FurnitureFooterVariant;
}

/**
 * FurnitureFooter - Unified component for Furniture footer with multiple variants
 */
export default function FurnitureFooter({ variant }: FurnitureFooterProps) {
  if (variant === 2) {
        ...
        <div className="w-full px-4 md:px-6 lg:px-8 py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-6 md:gap-8">
            ...
            <div className="xl:col-span-2">
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 hover:text-[#8B4513] transition-colors">
                FURNISH
              </h3>
              <p className="text-sm text-gray-600 leading-relaxed">
                Transform Your Home with Premium Furniture — Quality Meets Design.
              </p>
              ...
              <div className="flex items-center gap-4 mt-6">
                <Link
                  href="#"
                  className="w-10 h-10 bg-[#8B4513] text-white rounded-full flex items-center justify-center hover:bg-[#A0522D] transition-colors"
                >
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    href="#"
                    className="text-sm text-gray-700 hover:text-[#8B4513] transition-colors font-medium"
                  >
                    About Us
                  </Link>
                </li>
            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-gray-300 text-sm focus:outline-none focus:border-[#8B4513]"
                />
                <button className="px-4 py-2 bg-[#8B4513] text-white text-sm font-semibold hover:bg-[#A0522D] transition-colors">
                  Subscribe
                </button>
              </div>
            </div>
  ...
  // Variant 1: Furniture Studio Footer
  return (
        ...
        <div className="block md:hidden space-y-8">
          ...
          <div className="text-center space-y-4">
            <div className="border border-white p-3 w-fit mx-auto">
              ...
              <div className="text-sm text-center">HOUSE</div>
            </div>
            <p
              className="text-gray-300 max-w-xs mx-auto"
              style={{ fontSize: "14px" }}
            >
              Discover furniture that fits your lifestyle. From casual looks to
              statement pieces.
            </p>
          </div>
