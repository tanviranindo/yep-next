            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  This dress is crafted from soft, breathable fabric that keeps you comfortable all day long. Designed
                  with a flattering silhouette and versatile styling, it's perfect for casual outings or everyday wear.
                  The lightweight material ensures comfort, and easy care fabric makes it ideal to wear in any
                  condition.
                </p>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-600">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Light, airy, and flowy with a soft sheer finish</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-green-500 text-lg">✓</span>
                ...
                <p className="text-gray-600">
                  Crafted with attention to detail, this dress offers premium quality in both fabric and finish. From
                  the stitching to fit, every element is designed for durability, comfort, and lasting elegance. It's a
                  piece you can wear with confidence — again and again.
                </p>
              </div>
            </div>
          )}
          ...
          {activeTab === "reviews" && (
            <div className="space-y-6">
              ...
              <div className="border-b border-gray-200 pb-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Zhon Abony - August 12, 2023</p>
                  </div>
                </div>
                <p className="text-gray-700">
                  I recently purchased the Arino T-shirts and I'm thoroughly impressed. The sound quality is exceptional,
                  the wireless connectivity is seamless, and the noise cancellation technology is fantastic. Features:
                  They're a bit pricey, but well worth the investment. Highly recommend.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600">Your email address will not be published. Required fields are marked *</p>
                ...
                <div className="flex items-start gap-2">
                  <input type="checkbox" id="save-info" className="rounded mt-1" />
