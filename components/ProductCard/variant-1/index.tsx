...
export default function ProductCardVariant1({
  ...
  return (
    <article
      className={clsx(
        "card bg-base-100 shadow hover:shadow-lg transition-shadow",
        className
      )}
      itemScope
    ...
    >
      ...
      <div className="card-body">
        <h3 className="card-title text-base-content" itemProp="name">
          {product.name}
        </h3>
        {product.description ? (
          <p className="text-sm opacity-70 line-clamp-2" itemProp="description">
            {product.description}
          </p>
        ) : null}
