...
/**
 * BeautyFooter - Unified component for Beauty footer with multiple variants
 *
 * Variant 1: Dark gradient footer with newsletter section (GLAMOUR)
 * Variant 2: Light gradient footer with natural theme (NIKA)
 */
export default function BeautyFooter({ variant }: BeautyFooterProps) {
  if (variant === 2) {
    // Variant 2: NIKA Footer with natural theme
    return (
  ...
  // Variant 1: GLAMOUR Footer with dark theme
  return (
