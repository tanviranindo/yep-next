...
export const FURNITURE2_BASE_ROUTE = "/furniture2";

// Navigation routes
export const FURNITURE2_ROUTES = {
  HOME: FURNITURE2_BASE_ROUTE,
  SHOP: `${FURNITURE2_BASE_ROUTE}/shop`,
  PRODUCTS: `${FURNITURE2_BASE_ROUTE}/products`,
  PRODUCT_BASE: `${FURNITURE2_BASE_ROUTE}/product`,
  CART: `${FURNITURE2_BASE_ROUTE}/cart`,
  WISHLIST: `${FURNITURE2_BASE_ROUTE}/wishlist`,
  CHECKOUT: `${FURNITURE2_BASE_ROUTE}/checkout`,
  REVIEW_ORDER: `${FURNITURE2_BASE_ROUTE}/review-order`,
  ORDER_CONFIRMED: `${FURNITURE2_BASE_ROUTE}/order-confirmed`,
  TRACK_ORDER: `${FURNITURE2_BASE_ROUTE}/track-order`,
  PROMOTIONS: `${FURNITURE2_BASE_ROUTE}/promotions`,
  FAQ: `${FURNITURE2_BASE_ROUTE}#faq`,
} as const;

// Helper function for dynamic routes
export const getFurniture2ProductUrl = (id: string) => `${FURNITURE2_BASE_ROUTE}/product/${id}`;
