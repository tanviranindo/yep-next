// Base route for Beauty UI 2 (NIKA - Beige/Tan Theme)
export const BEAUTY2_BASE_ROUTE = "/beauty2";

// Navigation routes
export const BEAUTY2_ROUTES = {
  HOME: BEAUTY2_BASE_ROUTE,
  SHOP: `${BEAUTY2_BASE_ROUTE}/shop`,
  PRODUCTS: `${BEAUTY2_BASE_ROUTE}/products`,
  PRODUCT_BASE: `${BEAUTY2_BASE_ROUTE}/product`,
  CART: `${BEAUTY2_BASE_ROUTE}/cart`,
  WISHLIST: `${BEAUTY2_BASE_ROUTE}/wishlist`,
  CHECKOUT: `${BEAUTY2_BASE_ROUTE}/checkout`,
  REVIEW_ORDER: `${BEAUTY2_BASE_ROUTE}/review-order`,
  ORDER_CONFIRMED: `${BEAUTY2_BASE_ROUTE}/order-confirmed`,
  TRACK_ORDER: `${BEAUTY2_BASE_ROUTE}/track-order`,
  PROMOTIONS: `${BEAUTY2_BASE_ROUTE}/promotions`,
  FAQ: `${BEAUTY2_BASE_ROUTE}#faq`,
} as const;

// Helper function for dynamic routes
export const getBeauty2ProductUrl = (id: string) => `${BEAUTY2_BASE_ROUTE}/product/${id}`;
...
export const FAQ_ITEMS = [
  {
    ...
    a: "Browse our natural beauty collection, add items to your cart, and proceed to checkout. You can track your order status through our Track Order page after placing your order."
  },
  {
...
// Brand theme color
export const BRAND_COLOR = "#D4A574"; // Beige/Tan for NIKA
