...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  const productData = {
    ...
    2: { name: 'Product 2', price: '$149', description: 'Another great product with premium quality.' },
    3: { name: 'Product 3', price: '$199', description: 'Premium quality product with excellent durability.' },
  }
  ...
  return (
    <div className="min-h-screen bg-base-100">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="card w-full max-w-2xl mx-auto bg-base-200 shadow-xl">
