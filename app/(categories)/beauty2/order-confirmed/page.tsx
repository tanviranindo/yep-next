    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        <div className="text-center">
          ...
          {/* Order Details Card */}
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-8 mb-8 text-left">
            <div className="space-y-4">
              <div className="flex justify-between items-center pb-4 border-b border-amber-200">
                ...
                <span className="text-xl font-bold text-[#D4A574]">{orderNumber}</span>
              </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <p className="text-gray-600">
              ...
              <a href="#" className="text-[#D4A574] hover:underline font-medium">
                customer support
              </a>
            </p>
          </div>
