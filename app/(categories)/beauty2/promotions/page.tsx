...
import { saleProducts, hotDeals } from "@/data/beauty2/products";
...
export default function PromotionsPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="relative h-[400px] md:h-[500px] bg-gradient-to-r from-amber-50 to-orange-50 overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-between px-4 md:px-20">
          ...
          <div className="max-w-xl z-10">
            ...
            <p className="text-gray-700 text-lg mb-6">
              Discover natural beauty products that elevate your glow. From organic skincare to eco-friendly makeup.
            </p>
            <a
              href="#products"
              className="inline-block px-8 py-3 bg-[#D4A574] text-white hover:bg-[#C89563] transition-colors rounded-md"
            >
              Shop Now &rarr;
            </a>
          </div>
          ...
          <div className="hidden md:block absolute right-0 top-0 h-full w-1/2 bg-gradient-to-l from-amber-100 to-transparent">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <span className="inline-block px-6 py-2 bg-[#D4A574] text-white text-sm font-semibold mb-4 rounded-full">
              SALE
            </span>
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Special Sale On Natural Beauty Products
            </h2>
          </div>
          ...
          >
            {saleProducts.map((product) => (
              <div key={product.id} className="relative">
                <span className="absolute top-2 left-2 z-10 bg-[#D4A574] text-white text-xs px-3 py-1 font-semibold rounded-full">
                  SALE
                </span>
                <BeautyProductCard variant={2} product={product} />
              </div>
            ))}
          </div>
          ...
          <div className="text-center mt-12">
            <a
              ...
              className="inline-block px-8 py-3 border-2 border-[#D4A574] text-gray-900 hover:bg-[#D4A574] hover:text-white transition-colors rounded-md"
            >
              See All Products
            </a>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {hotDeals.map((product) => (
              <BeautyProductCard key={product.id} variant={2} product={product} />
            ))}
          </div>

          <div className="text-center mt-8 md:hidden">
            <a href={BEAUTY2_ROUTES.SHOP} className="text-gray-900 hover:underline">
              See All &rarr;
            </a>
          </div>
        </div>
