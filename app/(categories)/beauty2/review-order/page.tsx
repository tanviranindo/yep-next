...
export default function ReviewOrderPage() {
  ...
  if (cart.length === 0 && !currentOrder) {
    router.push(BEAUTY2_ROUTES.CART);
    return null;
  }
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-sm text-gray-600 mb-8">
          ...
          <Link href={BEAUTY2_ROUTES.CART} className="hover:text-[#D4A574]">
            My Orders
          </Link>
          <span className="mx-2">/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {orderItems.map((item) => (
                  <div key={item.id} className="flex gap-4 pb-4 border-b border-gray-200 last:border-0">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-lg font-bold text-[#D4A574] mt-2">
          ...
          <div className="lg:col-span-1">
            <div className="bg-amber-50 border border-gray-200 rounded-lg p-6 sticky top-4">
              ...
              <div className="space-y-3">
                <Link
                  href={BEAUTY2_ROUTES.ORDER_CONFIRMED}
                  className="block w-full bg-[#D4A574] text-white text-center py-3 rounded-lg font-semibold hover:bg-[#C89563] transition-colors"
                >
                  Confirm Order
                </Link>
                <Link
                  href={BEAUTY2_ROUTES.CART}
                  className="block w-full text-center text-[#D4A574] hover:underline"
                >
                  Edit Order
                </Link>
              </div>
