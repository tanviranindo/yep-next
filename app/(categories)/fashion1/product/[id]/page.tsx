...
import { getProductById, relatedProducts } from "@/data/fashion1/products";
import { FASHION1_ROUTES, PRODUCT_SIZES, PRODUCT_COLORS } from "@/data/fashion1/constants";
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 px-6 py-4 bg-black text-white font-semibold hover:bg-gray-800 transition-colors"
              >
                ADD TO CART
              </button>
              <button
            ...
            {activeTab === "description" && (
              <div className="prose max-w-none">
                ...
                <ul className="space-y-2">
                  <li>Light and soft fabric with drawstring detail</li>
                  <li>Elegant women's wear, great for party</li>
                  <li>Slightly stretchable with soft satin lined</li>
                  <li>2-way breathable with side seam pockets</li>
                </ul>
              </div>
            )}
                ...
                <table className="w-full">
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3">Premium Cotton Blend</td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 text-gray-600">Care Instructions</td>
                      <td className="py-3">Machine wash cold, tumble dry low</td>
                    </tr>
                  </tbody>
                </table>
              </div>
