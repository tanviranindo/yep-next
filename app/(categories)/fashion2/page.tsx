...
export default function Fashion2Page() {
  const faqItems = [
    { q: "What is your return policy?", a: "We offer a 30-day return policy for all unworn items with original tags. Simply contact our customer service team to initiate a return." },
    ...
    { q: "How can I track my order?", a: "Once your order ships, you'll receive a tracking number via email that you can use to monitor your delivery." },
    { q: "What payment methods do you accept?", a: "We accept all major credit cards, PayPal, and various digital payment methods." },
    { q: "Are your products authentic?", a: "Yes, all our jewelry is 100% authentic and comes with a certificate of authenticity." },
  ];
  return (
